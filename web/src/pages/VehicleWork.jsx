...
export default function VehicleWork() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Vehicle Work Services 🚜</h1>
        <p className="text-gray-500 text-sm mt-0.5">Ploughing, harvesting and field work with agricultural vehicles</p>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState icon="🚜" title="No vehicle work listings" description="No vehicles available for field work in this area." />
      ) : (
        <>
